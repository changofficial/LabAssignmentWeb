(function (global, factory) {
  ...
  */
  ...
  function buildMidiNumberAttributesCache() {
    return lodash_range(MIN_MIDI_NUMBER, MAX_MIDI_NUMBER + 1).reduce(function (cache, midiNumber) {
  ...
  var NATURAL_MIDI_NUMBERS = lodash_range(MIN_MIDI_NUMBER, MAX_MIDI_NUMBER + 1).filter(function (midiNumber) {
  ...
  function (_React$Component) {
    ...
    function Key() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "playNote", function () {
        _this.props.onPlayNote(_this.props.midiNumber);
      });

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "stopNote", function () {
        _this.props.onStopNote(_this.props.midiNumber);
      });
  ...
  function (_React$Component) {
    ...
    _createClass(Keyboard, [{
      ...
      value: function getMidiNumbers() {
        return lodash_range(this.props.noteRange.first, this.props.noteRange.last + 1);
      }
    }, {
      ...
      value: function render() {
        ...
        return React.createElement("div", {
          ...
          return React.createElement(Key, {
            ...
            disabled: _this.props.disabled,
            onPlayNote: _this.props.onPlayNote,
            onStopNote: _this.props.onStopNote,
            gliss: _this.props.gliss,
            useTouchEvents: _this.props.useTouchEvents,
            key: midiNumber
  ...
  function (_React$Component) {
    ...
    function Piano(props) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Piano).call(this, props));
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleNoteChanges", function (_ref) {
        ...
        var notesStarted = lodash_difference(prevActiveNotes, nextActiveNotes);
        var notesStopped = lodash_difference(nextActiveNotes, prevActiveNotes);
        notesStarted.forEach(function (midiNumber) {
          _this.onStopNote(midiNumber);
        });
        notesStopped.forEach(function (midiNumber) {
          _this.onPlayNote(midiNumber);
        });
      });
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getMidiNumberForKey", function (key) {
        ...
        var shortcut = lodash_find(_this.props.keyboardShortcuts, {
          key: key
        });
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onPlayNote", function (midiNumber) {
        if (_this.props.disabled) {
          return;
        } // Prevent duplicate note firings


        var isActive = _this.state.activeNotes.includes(midiNumber);
        ...
        _this.props.onPlayNote(midiNumber, _this.state.activeNotes);
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onStopNote", function (midiNumber) {
        if (_this.props.disabled) {
          return;
        }

        var isInactive = !_this.state.activeNotes.includes(midiNumber);
        ...
        _this.props.onStopNote(midiNumber, _this.state.activeNotes);
  ...
  _defineProperty(Piano, "defaultProps", {
